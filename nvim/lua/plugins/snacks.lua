return {
  ...
  -- -@type snacks.Config
  opts = {
    -- All your existing options for enabling modules
  ...
  keys = {
    ...
    -- { "<leader>sb", function() Snacks.picker.lines() end, desc = "Buffer Lines" }, -- Duplicate keybind
    ...
    -- { "<leader>n", function() Snacks.notifier.show_history() end, desc = "Notification History" }, -- Duplicate keybind
